...
function MonthlyMIS() {
  const { data: reportData, isLoading, error } = useQuery({
    ...
    queryFn: () => getMonthlyReport({ dateFrom: '2024-01-01', dateTo: '2024-01-31' }) // Default dates, should be passed as params
  });
  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold mb-6">Monthly MIS Report</h1>
      ...
      <div className="bg-white rounded-lg border p-6 mb-6">
        ...
        <div className="grid grid-cols-5 gap-4">
          ...
          <div className="text-center">
            <div className="text-2xl font-bold text-purple-600">{reportData.summary.performanceScore}%</div>
      ...
      {/* Department Summary */}
      <div className="bg-white rounded-lg border p-6 mb-6">
        <h2 className="text-lg font-semibold mb-4">Department Performance Summary</h2>
